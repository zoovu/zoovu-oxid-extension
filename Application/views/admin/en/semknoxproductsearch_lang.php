...
$aLang = array(
  ...
  'SHOP_MODULE_sxCategoryQueryTitle' => 'show category products via SEMKNOX',
...
foreach ($oxLanguage->getLanguageArray() as $lang) {
  ...
  $aLang['SHOP_MODULE_sxHideRangeInRangeSliderTitle' . $oxid] = $aLang['SHOP_MODULE_sxHideRangeInRangeSliderTitle'] . ' - Shop-Language: ' . $language;
  $aLang['SHOP_MODULE_sxCategoryQueryTitle' . $oxid] = $aLang['SHOP_MODULE_sxCategoryQueryTitle'] . ' - Shop-Language: ' . $language;
}